...
def waveform_to_log_mel_spectrogram_patches(waveform):
...
def pad_waveform(waveform, params):
  ...
  padded_waveform = tf.pad(waveform, [[0,0], [0, num_padding_samples]],
...
def _waveform_to_mfcc(waveform, params):
    log_mel_spectrograms = waveform_to_log_mel_spectrogram_patches(waveform, params)
